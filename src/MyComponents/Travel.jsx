...
import Mother from "../assets/Image/png/Mother_andriod_movie.png";
import Extraction from "../assets/Image/png/Extraction.png";
import Weekned from "../assets/Image/png/The_weekned_way_movie.png";
import Lucy from "../assets/Image/png/Lucy_movie.png";
      ...
      <section className="bg_black">
        <div className="container-fluid px-lg-5 py-4">
          <div className="d-flex justify-content-between align-items-center pt-5 px-lg-5">
            <h2 className="text-white fw_md fs_md">Travel</h2>
