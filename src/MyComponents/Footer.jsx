    ...
    <>
      <footer className="py-md-5 footer_bg">
        <div className="container py-5">
          <div className="bg_danger max_width_350_xsm footer_shadow d-flex  max_width_700 mx-auto p-sm-3 p-2 pb-3  flex-column flex-sm-row align-items-center justify-content-between rounded">
